<input type="hidden" name="user_id" id="user_id" value="{{$prof->user_id}}" required>
<!-- Nom Field -->
...
<div class="form-group col-sm-6">
    ...
    <select class="form-control" name="sexe" id="sexe" required>
        <option value="Masculin"@if($prof->sexe == 'Masculin') selected="true" @endif>Masculin</option>
        <option value="Feminin"@if($prof->sexe == 'Feminin') selected="true" @endif>Feminin</option>
        <option value="Autre"  @if($prof->sexe == 'Autre') selected="true" @endif>Autre</option>        
    </select>
</div>
...
<div class="form-group col-sm-6">
    ...
    <select class="form-control" name="statusmatrimonial" id="statusmatrimonial" required>
        ...
        <option value="Marié(e)" @if($prof->statusmatrimonial == 'Marié(e)') selected="true" @endif>Marié(e)</option>
        <option value="Divorcé(e)" @if($prof->statusmatrimonial == 'Divorcé(e)') selected="true" @endif>Divorcé(e)</option>
        <option value="Veuf(ve)" @if($prof->statusmatrimonial == 'Veuf(ve)') selected="true" @endif>Veuf(ve)</option>
    </select>
</div>
...
<div class="form-group col-sm-6">
    ...
    <select class="form-control" name="option" id="option" required>
        ...
        <option value="Jardinière" @if($prof->option == 'Jardinière') selected="true" @endif>Jardinière</option>
        <option value="Aide-Jardinière" @if($prof->option == 'Aide-Jardinière') selected="true" @endif>Aide-Jardinière</option>
        <option value="Fondamental" @if($prof->option == 'Fondamental') selected="true" @endif>Fondamental</option>
        <option value="Directrice pédagogique" @if($prof->option == 'Directrice pédagogique') selected="true" @endif>Directrice pédagogique</option>
    </select>
</div>
<!-- Image Field -->
    ...
    <div class="from-group form-group-login">
        <table style="margin:0 auto;">
            ...
            <tbody>
                <tr>
                    <td class="image" >
                        {!!Html::image('user_images/'.$prof->image,
                        null,
